...
[Notificaties API-Lab.postman_collection.json.zip](https://github.com/VNG-Realisatie/notificatieservices/files/8890465/Notificaties.API-Lab.postman_collection.json.zip)
